  ...
  return (
    <footer>
      ...
      <div className='footer-elements'>
        ...
        <div id="icons">
          <a className='icon-link' href="https://github.com/Harika-uppala" target="_blank">
            <i className="fa-brands fa-github-square fa-2xl"></i>
          </a>
          <a className='icon-link' href="https://www.linkedin.com/mwlite/in/harika-uppala-19b09526a" target="_blank">
